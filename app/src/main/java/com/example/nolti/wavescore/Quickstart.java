...
public class Quickstart extends Activity
    implements EasyPermissions.PermissionCallbacks {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mCallApiButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mOutputText.setText("");
                    getResultsFromApi(); // devuelve los resultados de la Api
            ...
            // Inicializo credenciales y objeto de servicio de Google
        ...
        /**
         * Intenta llamar a la API, después de verificar que todas las condiciones previas son satisfied.
         * Las condiciones previas son: Servicios de Google Play instalados,
         * se selecciona una cuenta y si el dispositivo actualmente tiene acceso en línea.
         * Si alguna de las condiciones previas no se cumplen, la aplicación le indicará al usuario apropiado.
         */
        private void getResultsFromApi() {
            if (! isGooglePlayServicesAvailable()) {
                acquireGooglePlayServices();
                Log.d("ADQUIRIR GPLAY SERVICES", "acquireGooglePlayServices()" );
        ...
        /**
         * Chekea si el dispositivo esta conectado a la red.
         * @return true si el dispositivo tiene una conexión de red, false de lo contrario.
         */
        ...
        /**
         * Intentar resolver un faltante, desactualizado (out-of-date), inválido o deshabilitado de Google
         * Instala los Play Services a través de un user dialog, si es posible.
         */
        ...
        private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
            ...
            MakeRequestTask(GoogleAccountCredential credential) {
                ...
                mService = new com.google.api.services.script.Script.Builder(
                        ...
                        .setApplicationName("Google Apps Script API Android Quickstart")
                        .build();
            }
