...
import com.voltiosx.wavescore.ui.adapters.FixtureAdapter;
            ...
            *//* ENCABEZADO ASIGNADO *//*
            ...
            for (int i=0; i<heatgroup; i++){ //for necesario para agrupar
                if (r<totalridersfixture) {
                    ...
                    int colortextcontrast = ContextCompat.getColor(context, R.color.colorTextLight);
                    int tshirtcolor = ContextCompat.getColor(context, R.color.inactive);
