...
import com.voltiosx.wavescore.ui.adapters.HeatAdapter;
...
// --Commented out by Inspection STOP (24/04/2018 11:21)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        timeStandby = ContextCompat.getColor(context, R.color.monokai_blue);
        timeOver = ContextCompat.getColor(context, R.color.monokai_pink);
        timeEnough = ContextCompat.getColor(context, R.color.monokai_green);
        timeShort = ContextCompat.getColor(context, R.color.monokai_yellow);

        // inicializo colores lycras
        int colorTextLight, colorTextDark;
        colorTextLight = ContextCompat.getColor(context, R.color.colorTextLight);
        colorTextDark = ContextCompat.getColor(context, R.color.colorTextDark);
        int lycra1, lycra2, lycra3, lycra4, lycra5, lycra6, lycra7, lycra8;
        lycra1 = ContextCompat.getColor(context, R.color.colorLycra1);
        lycra2 = ContextCompat.getColor(context, R.color.colorLycra2);
        lycra3 = ContextCompat.getColor(context, R.color.colorLycra3);
        lycra4 = ContextCompat.getColor(context, R.color.colorLycra4);
        lycra5 = ContextCompat.getColor(context, R.color.colorLycra5);
        lycra6 = ContextCompat.getColor(context, R.color.colorLycra6);
        lycra7 = ContextCompat.getColor(context, R.color.colorLycra7);
        lycra8 = ContextCompat.getColor(context, R.color.colorLycra8);
            ...
            while (i < t) {
                ...
                if (initScore == 0.0) {
                    ...
                    if(i==9){
                        ...
                        new MaterialDialog.Builder(context).content(mensaje).positiveText(R.string.agree).show();
                    }
                    break;
                }
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (clicks==1) {
                            ...
                            new MaterialDialog.Builder(context).content("Proximamente se podra editar aqui el tiempo de este CRONOMETRO").positiveText(R.string.agree).show();
                        }
                        clicks=0;
                    }
                }, 400);
    ...
    e iguala su context y llama a los métodos de la Interfaz para comunicarse con la Actividad. */

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        // Igualo el context del scorepickercomunicator con la MainActivity
